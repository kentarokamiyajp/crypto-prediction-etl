...
with DAG(
    ...
    process_crude_oil_price = PythonOperator(
        ...
        op_kwargs={"task_id_for_xcom_pull": "get_crude_oil_price"},
    ...
    insert_data_to_cassandra = PythonOperator(
        ...
        op_kwargs={
            "task_id_for_xcom_pull": "process_crude_oil_price_for_ingestion",
