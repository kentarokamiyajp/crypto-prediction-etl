...
from common_functions.poloniex_operation import get_candle_day_data, process_candle_data
...
with DAG(
    ...
    get_candle_data_via_poloniex = PythonOperator(
        ...
        python_callable=get_candle_day_data,
        pool="poloniex_pool",
        op_kwargs={
    ...
    process_poloniex_candle_data = PythonOperator(
        ...
        op_kwargs={"task_id_for_xcom_pull": "get_candle_day"},
