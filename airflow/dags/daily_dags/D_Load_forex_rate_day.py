...
with DAG(
    ...
    process_forex_rate = PythonOperator(
        ...
        op_kwargs={"task_id_for_xcom_pull": "get_forex_rate"},
    ...
    insert_data_to_cassandra = PythonOperator(
        ...
        op_kwargs={
            "task_id_for_xcom_pull": "process_forex_rate_for_ingestion",
