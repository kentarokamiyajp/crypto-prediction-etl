...
HIVE_CONFIG = {
    "source_schema": "gold_raw",
    "source_table": "gold_price_day",
...
def main(dwh_module_home, N_month, update_N_months_from):
    ...
    with BaseSparkSession(SPARK_CONFIG, base_spark_app_name) as spark_session:
        ...
        for row in gold_symbol_df.select(gold_symbol_df.id).collect():
            ...
            quotes = get_quotes(pd_gold_history_df, N_multiple)
