DROP TABLE gold_mart.wrk_gold_indicator_day;

CREATE TABLE IF NOT EXISTS gold_mart.wrk_gold_indicator_day (
    id string COMMENT 'id of the gold',
...
COMMENT 'gold indicator for each day'
