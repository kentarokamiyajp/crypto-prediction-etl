DROP TABLE gas_mart.wrk_natural_gas_indicator_day;

CREATE TABLE IF NOT EXISTS gas_mart.wrk_natural_gas_indicator_day (
    id string COMMENT 'id of the natural gas',
