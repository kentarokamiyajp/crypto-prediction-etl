DROP TABLE oil_mart.wrk_crude_oil_indicator_day;

CREATE TABLE IF NOT EXISTS oil_mart.wrk_crude_oil_indicator_day (
    id string COMMENT 'id of the crude oil',
...
COMMENT 'crude oil indicator for each day'
