DROP TABLE stock_mart.wrk_stock_index_indicator_day;

CREATE TABLE IF NOT EXISTS stock_mart.wrk_stock_index_indicator_day (
...
COMMENT 'stock index indicator for each day'
