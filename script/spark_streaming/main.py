...
subprocess.call(
    f"""nohup spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.2.0,com.datastax.spark:spark-cassandra-connector_2.12:3.0.0 \
                    ...
                    2> {logdir}/nohup_error_nohup_out_spark_coins_market_{curr_timestamp}.log &""",
    shell=True,
)
