...
consumer_id = "realtime_trading_dashboard_v2"
topic_id = "crypto.realtime_trading_bot_v2"
# group_id = os.environ.get("GROUP_ID")
group_id = "realtime_trading_dashboard_v2_" + datetime.now().strftime("%Y%m%d%H%M")
offset_type = "latest"
