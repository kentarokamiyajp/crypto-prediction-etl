...
consumer_id = "realtime_trading_dashboard"
topic_id = "crypto.realtime_trading_bot_v1"
# group_id = os.environ.get("GROUP_ID")
group_id = "realtime_trading_dashboard_" + datetime.now().strftime("%Y%m%d%H%M")
offset_type = "latest"
...
while True:
    ...
    if len(df) > 1:
        with open(
            "/Users/kamiken/git/crypto_prediction_dwh/script/kafka_consumers/data_for_rt_dashboard.pkl",
            "wb",
        ) as f:
            pickle.dump(df, f)
