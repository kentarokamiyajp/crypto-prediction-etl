...
consumer_id = "realtime_trading_dashboard_v3"
topic_id = "crypto.realtime_trading_bot_v3"
# group_id = os.environ.get("GROUP_ID")
group_id = "realtime_trading_dashboard_v3_" + datetime.now().strftime("%Y%m%d%H%M")
offset_type = "latest"
...
while True:
    ...
    if len(df) > 1 and save_time_diff > 5:
        with open(
            "/Users/kamiken/git/crypto_prediction_dwh/script/kafka_consumers/data_for_rt_dashboard_v3.pkl",
            "wb",
        ) as f:
            pickle.dump(df, f)
