...
dag_id = "OT_Create_stock_index_value_indicator_day"
tags = ["onetime", "create", "stock"]
...
with DAG(
    dag_id,
    description="Create mart tables for natural stack index indicators",
    ...
    query_script = "OT_Create_stock_index_value_ind_day_001"
    ...
    spark_script = "OT_Create_stock_index_value_ind_day_001"
    create_stock_index_value_indicators = SparkSubmitOperator(
        task_id="create_stock_index_value_indicators",
    ...
    (dag_start >> init_hive_mart_table >> create_stock_index_value_indicators >> dag_end)
