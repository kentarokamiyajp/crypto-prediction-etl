...
dag_id = "OT_Create_forex_rate_indicator_day"
tags = ["onetime", "create", "forex"]
...
with DAG(
    dag_id,
    description="Create mart tables for forex rate indicators",
    ...
    query_script = "OT_Create_forex_rate_ind_day_001"
    ...
    spark_script = "OT_Create_forex_rate_ind_day_001"
    create_forex_rate_indicators = SparkSubmitOperator(
        task_id="create_forex_rate_indicators",
    ...
    (dag_start >> init_hive_mart_table >> create_forex_rate_indicators >> dag_end)
