...
dag_id = "OT_Create_natural_gas_price_indicator_day"
tags = ["onetime", "create", "gas"]
...
with DAG(
    dag_id,
    description="Create mart tables for natural gas price indicators",
    ...
    query_script = "OT_Create_natural_gas_price_ind_day_001"
    ...
    (dag_start >> init_hive_mart_table >> create_natural_gas_price_indicators >> dag_end)
