...
dag_id = "OT_Create_gold_price_indicator_day"
tags = ["onetime", "create", "gold"]
...
with DAG(
    dag_id,
    description="Create mart tables for gold price indicators",
    ...
    query_script = "OT_Create_gold_price_ind_day_001"
    ...
    spark_script = "OT_Create_gold_price_ind_day_001"
    create_gold_price_indicators = SparkSubmitOperator(
        task_id="create_gold_price_indicators",
    ...
    (dag_start >> init_hive_mart_table >> create_gold_price_indicators >> dag_end)
