...
dag_id = "D_Load_crypto_candles_realtime"
...
with DAG(
    dag_id,
    description="Load candles realtime data collected by Kafka producer",
    ...
    delete_past_data_from_hive = PythonOperator(
        ...
        op_kwargs={
            "query_file": f"{query_dir}/D_Load_crypto_candles_realtime_001.sql",
    ...
    hive_deletion_check = PythonOperator(
        ...
        op_kwargs={
            "query_file": f"{query_dir}/D_Load_crypto_candles_realtime_002.sql",
            "days_delete_from": days_delete_from,
        },
    )
    ...
    load_from_cassandra_to_hive = PythonOperator(
        ...
        op_kwargs={
            "query_file": f"{query_dir}/D_Load_crypto_candles_realtime_003.sql",
            "days_delete_from": days_delete_from,
