...
query = f"select id, cast(dt as string) as dt, open, high, low, close, amount as volume, \
    year, month, day from {target_schema}.{target_table} where dt >= add_months(current_date,{use_N_months_data_to_calculate_indicator})"
